...
void SpawnJester(int JesterPositionX, int JesterPositionY, Sprite JesterCurrentLocation[1]){
	Sprite JesterSprite = JesterCurrentLocation[1];
	JesterSprite.setPosition(JesterPositionX *50, JesterPositionY *50);
...
int main()
{
	...
	Vector2f JesterLocation (15, 550);
	...
	Sprite JesterCurrentLocation[1] = {JesterSprite};
	//Array
	srand(time(NULL));
